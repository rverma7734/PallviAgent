# A2P / Twilio Registration Notes

## Suggested campaign description

PallviAgent is an inbound-first SMS intake assistant for immigration emergency callback coordination. Users text the number to request help, consent to continue by SMS, provide basic emergency intake information, and receive status or callback coordination messages. Messages are not promotional or marketing. Automated SMS messages do not provide legal advice and do not create an attorney-client relationship.
